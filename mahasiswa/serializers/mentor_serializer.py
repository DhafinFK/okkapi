...
from ..models import Mentor, Mahasiswa
...
class MentorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Mentor
        fields = ['id', 'mahasiswa', 'kelompok', 'nomor', 'mahasiswa_id']
        read_only = [id,]
    ...
    def validate_nomor(self, data):
        ...
        if Mentor.objects.filter(kelompok=kel):
            raise ValidationError('Mentor di kelompok itu sudah ada')
        return data
    ...
    def create(self, validated_data):
        ...
        mentor = Mentor.objects.create(mahasiswa=mahasiswa, kelompok=kelompok)
        return mentor
